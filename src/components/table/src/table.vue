<!--
 * @Author: zhoulf
 * @FilePath: /testvue/src/components/table/src/table.vue
 * @Date: 2021-12-10 11:47:53
 * @LastEditors: zhoulf
 * @LastEditTime: 2021-12-13 10:15:50
 * @Description: 
-->
<script>
import { Table } from "element-ui";
  ...
  Object.assign(wrapTable.methods, {
    ...
    genFields(data) {
      const columns = []
      if (this.indexCol) {
        const indexCol = { label: "序号", type: "index", index: this.typeIndex, align: "center", width: "54" }
      ...
      if (this.selectionCol) {
        const selectionCol = { type: "selection", label: "全选", align: "center", width: "44" }
